...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.text=[[arr_mute objectAtIndex:indexPath.row]objectForKey:@"title"];
    
    NSURL *url=[NSURL URLWithString:[[arr_mute objectAtIndex:indexPath.row]objectForKey:@"img"]];
